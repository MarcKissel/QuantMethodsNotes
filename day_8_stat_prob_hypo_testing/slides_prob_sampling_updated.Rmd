...
## Lets say I ask 1000 people in the US if they will vote Democrat or Republican in 2020...but there are ~325 million people in the US.
...
### In stats it is the other way around! 
### we have data and we want to know something about the world

example of stats questions:
___
...
## infinite sequences don't exist in the real world
...
normal.a <- rnorm( n=1000, mean=0, sd=1 )
normal.a[1]
set.seed(100) #what is this doing?
```
...
## 1. take sample of 40 from the bowl  in front and calculate the proporiton of white
...
2. the results based on the sample can generalize to the population and 
