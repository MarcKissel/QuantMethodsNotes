...
##Now it is time to put what we talked about into practice. Everyone is going to get two objects that have candy in them. **Without talking to anyone else** i want you to create a spreadsheet of the *data* you have. Can use any spreadsheet program or do it on a piece of paper. 

#Answer the questions on the handout. Then put the candy back in the eggs and/or eat the candy!

if you have time, calculate some summary stats (mean, median, etc) if you know how to. if not, no worries :) 
...
##Now, get into groups of 3. Share your data in the group and try to pool the data into one larger spreadsheet. 

##Questions

## 1. Was it easy to pool the data
## 2. what problems did you have
## 3. what might you do differently if you started with all the data

# Now, create a new spreadsheet that works best for the data. Make sure it fits with the rules we discussed before
...
show figures 5 and fig 7 n pg12+ of bowman and woo and hvae them note what might be wrong and think about how to betwer store them
