...
lets say my null will be that brain size stays the same with a hominin species, so Ѳ = .5
...
statistic for the real data (e.g., X = 62) and then compare it to the critical values to make our decision. Since 62 is greater than the critical value of 60, we would reject the null hypothesis. Or, to phrase it
